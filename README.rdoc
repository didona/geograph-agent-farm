...
1. Install TorqueBox v2.0.0.beta2 (download it here[http://torquebox.org/release/org/torquebox/torquebox-dist/2.0.0.beta2/torquebox-dist-2.0.0.beta2-bin.zip] and follow these[http://torquebox.org/documentation/current/installation.html] instructions).
...
5. Load the Gpx routes examples using the rake task provided:
    jruby -S rake agent_farm:load_gpxs
...
8. Open the browser at http://localhost:8080, signup and you will see the Geograph Agent Farm console.